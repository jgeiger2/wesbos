...
![browser console output of 'data'](./1114.png)
...
![browser output showing accesing JSON object properties](./1115.png)
...
![browser console showing output of a promise](./1116.png)
...
![browser network tab showing preview response](./1118.png)
...
![browser console showing response output](./1120.png)
...
![browser console showing reponse output with body expanded](./1121.png)
...
![browser console showing the prototype functions of a api response object](./1122.png)
...
![browser console outputting data from an api response](./1123.png)
...
![text showing name and blog url](./1124.png)
...
![code snippet of displayUser function](./1125.png)
...
![browser console showing error output from api response](./1127.png)

_🔥HOT TIP: You can filter out just AJAX request from the Network tab by clicking XHR. 👇_

![broswer network tab showing filtered out XHR requests](./1126.png)
...
![rendered html page showing error from api response](./1129.png)

We will do one more example in the next lesson.
...
![list of public api endpoints](./1130.png)
